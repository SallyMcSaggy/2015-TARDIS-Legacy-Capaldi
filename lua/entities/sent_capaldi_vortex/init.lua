...
function ENT:Initialize()
	self:SetModel( "models/doctorwho1200/capaldi/vortex.mdl" )
...
function ENT:Toggle( bEnable, ply )
	...
	if IsValid(capaldi) and IsValid(interior) and not capaldi.moving then
	...
	if IsValid(self.capaldi) then
		net.Start("capaldiInt-ControlSound")
			...
			net.WriteString("doctorwho1200/capaldi/vortex.wav")
		net.Broadcast()
	end
end