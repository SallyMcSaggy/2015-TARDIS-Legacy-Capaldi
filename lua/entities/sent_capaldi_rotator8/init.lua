...
function ENT:Initialize()
	self:SetModel( "models/doctorwho1200/capaldi/rotator8.mdl" )
...
function ENT:Toggle( bEnable, ply )
	...
	if tobool(GetConVarNumber("capaldi_advanced"))==true and IsValid(interior) then
		if (interior.flightmode==1 or interior.flightmode==2 or interior.flightmode==3) and interior.step==6 then
	...
	if IsValid(self.capaldi) then
		net.Start("capaldiInt-ControlSound")
			...
			net.WriteString("doctorwho1200/capaldi/rotator.wav")
		net.Broadcast()
	end
end