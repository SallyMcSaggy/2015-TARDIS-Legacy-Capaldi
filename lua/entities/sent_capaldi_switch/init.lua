...
function ENT:Initialize()
	self:SetModel( "models/doctorwho1200/capaldi/switch.mdl" )
...
function ENT:Use( activator, caller, type, value )
	...
	if ( IsValid( self.LastUser ) ) then return end		-- Someone is already using this switchers
...
--
-- Makes the switchers trigger the keys
--
